...
if ( ( ( mouse_x - room_width + text_width) <= ( room_width - 5) ) && ( mouse_x - text_width ) < 0 ) { // Draw rect around the text
...
// Set color
old_color = draw_get_color(); draw_set_color(argument2);
